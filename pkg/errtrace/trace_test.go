...
func TestTrace(t *testing.T) {
	...
	want = "/pkg/errtrace/trace_test.go, line: 10, function: github.com/nexmoinc/gosrvlib/pkg/errtrace.init, error: ERROR GLOBAL VAR"
	...
	want = "/pkg/errtrace/trace_test.go, line: 32, function: github.com/nexmoinc/gosrvlib/pkg/errtrace.TestTrace.func1, error: ERROR LAMBDA FUNC"
	require.Contains(t, err.Error(), want, "unexpected output %v, want %v", err, want)
