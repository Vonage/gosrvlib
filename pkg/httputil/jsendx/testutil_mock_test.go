...
//
//	mockgen -package jsendx -destination ../httputil/jsendx/testutil_mock_test.go . TestHTTPResponseWriter
//

// Package jsendx is a generated GoMock package.
package jsendx
...
func (mr *MockTestHTTPResponseWriterMockRecorder) WriteHeader(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
